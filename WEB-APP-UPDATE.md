...
Your BantenLine article generator has been **upgraded to use Google Apps Script Web App** instead of direct Google Sheets API. This is **much simpler and more secure**.
